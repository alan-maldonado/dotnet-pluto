namespace Pluto.FluentAPI.Migrations
{
    using System;
    ...
    public partial class InitialModel : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CourseTags", "CourseId", "dbo.Course");
            DropForeignKey("dbo.Covers", "Id", "dbo.Course");
            DropForeignKey("dbo.Course", "AuthorId", "dbo.Authors");
